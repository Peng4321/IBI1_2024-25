...
import numpy as np
os.chdir("C://Users//IBI//IBI1_2024-25//Practical10")
...
for i in column:
    if i == 1990:
        ...
        list.append(False)
list1990=dalys_data.loc[list,[True,False,False,True]] #To out put the entity and dalys in all 1990 years
print(list1990)
...
for year in range(1990, 2020):
    dalys_in_same_year=dalys_data.loc[dalys_data.Year == year, ["Entity","DALYs"]]
    max_dalys = dalys_in_same_year.DALYs.max()
    country = dalys_in_same_year.loc[dalys_in_same_year.DALYs == max_dalys, "Entity"]
    print(f"In {year}, the country with the highest DALYs is {country} with {max_dalys} DALYs.")
